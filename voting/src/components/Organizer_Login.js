...
<div className="container my-5 p-3 rounded-2 myback2 d-flex justify-content-center " id="orglog">
<img className='m-5' src="../organizer-4098818-3408109.webp" alt="img error" height={350}/>

<div>
    <form action="">
    <div className='row m-5 justify-content-center'>
    <button type='button' value="otp_" className="btn btn-warning" onClick={()=>{wallet_connect()}} style={{width:"120px",fontSize:'25px'}}>Connect Wallet</button>
    </div>
